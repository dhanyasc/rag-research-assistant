...
class TestDocumentProcessor:
    ...
    def test_handles_unicode(self):
        content = "Unicode text: café, naïve".encode('utf-8')
...
class TestVectorStore:
    ...
    def test_keyword_matching(self):
        ...
        # Should find Python document with high score
...
class TestRAGChain:
    ...
    def test_answer_contains_relevant_content(self):
        result = self.chain.answer_question("What is Python?")
        # Answer should reference Python content
...
class TestIntegration:
    ...
    def test_pdf_like_content(self):
        processor = DocumentProcessor()
        # Simulate content that might come from a PDF
